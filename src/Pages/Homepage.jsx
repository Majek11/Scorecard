  ...
  return (
    <div>
      <header className="space-y-4">
        <h1 className='text-center text-[40px] font-[700] uppercase text-[#0F4C4B] leading-[80px] p-4 mt-[60px] font-["Inter"]'>
          2023 Nigerian Presidential <br /> Candidate Scoreboard
        </h1>

        <p className="flex gap-2 pl-[13%] justify-start text-[20px] text-[#0F4C4B] font-[400]">
        ...
        <p className='font-["Nunito_sans"] font-[700] text-[20px] pr-[1%] pb-4 text-center pt-4 text-[#0F4C4B]'>
    ...
    <div className="btn flex justify-center p-[70px] mb-10">
        <button className='text-white text-[21px] font-["Inter"] bg-[#0F4C4B] hover:bg-[#167674] text-base px-[60px] py-[25px] text-center'>Take a poll</button>
    </div>
    </Link>
      </header>
    </div>
